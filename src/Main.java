    ...
    private static void runTest(String testName, List<Integer> lineCounts, boolean runBruteForce) throws IOException {
        ...
        try {
            ...
            if (runBruteForce) {
                ...
                long costBrute = FileMergerBruteForce.mergeBruteForce(new ArrayList<>(files), outputDir);
                ...
                if (costBrute < costSeq) {
                    System.out.println(" (Força Bruta foi " + (costSeq - costBrute) + " bytes mais eficiente)");
                } else {
